# booking-service-java-akka-serverless

This project is an Akka Serverless service that demonstrates a simple booking service implemented as an Akka Serverless service.
